...
{
    public class SubjectCourseList
    {
        public List<Dto.SurveyReport.SubjectCourseList> SurveySubjectReportList { get; set; } = new List<Dto.SurveyReport.SubjectCourseList>();
        public List<Dto.SurveyReport.SubjectCourseList> SurveySubjectReportTextList { get; set; } = new List<Dto.SurveyReport.SubjectCourseList>();
        public List<Dto.SurveyReport.SubjectCourseList> SurveyTeacherList { get; set; } = new List<Dto.SurveyReport.SubjectCourseList>();
