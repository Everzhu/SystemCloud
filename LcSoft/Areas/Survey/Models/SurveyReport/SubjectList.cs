...
namespace XkSystem.Areas.Survey.Models.SurveyReport
{
    ...
    {
        public List<Dto.SurveyReport.SubjectList> SurveySubjectReportList { get; set; } = new List<Dto.SurveyReport.SubjectList>();
        public List<Dto.SurveyReport.SubjectList> SurveySubjectReportTextList { get; set; } = new List<Dto.SurveyReport.SubjectList>();
        public List<Dto.SurveyReport.SubjectList> SurveyTeacherList { get; set; } = new List<Dto.SurveyReport.SubjectList>();
