...
{
    public class SubjectCourseListHor
    {
        public List<Dto.SurveyReport.SubjectCourseListHor> SurveySubjectReportList { get; set; } = new List<Dto.SurveyReport.SubjectCourseListHor>();
        public List<Dto.SurveyReport.SubjectCourseListHor> SurveySubjectReportTextList { get; set; } = new List<Dto.SurveyReport.SubjectCourseListHor>();
        public List<Dto.SurveyReport.SubjectCourseListHor> SurveyTeacherList { get; set; } = new List<Dto.SurveyReport.SubjectCourseListHor>();
